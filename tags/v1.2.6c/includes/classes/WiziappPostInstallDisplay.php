...
class WiziappPostInstallDisplay{
    ...
    */
    ...
    public function batchPostsProcessing() {
        WiziappLog::getInstance()->write('info', "Got a request to process posts as a batch: " . print_r($_POST, TRUE),
    ...
    public function batchProcessPages() {
        WiziappLog::getInstance()->write('info', "Got a request to process pages as a batch: " . print_r($_POST, TRUE),
    ...
    public function batchProcessingFinish(){
        WiziappLog::getInstance()->write('debug', "The batch processing is finished, marking as finished",
        ...
        WiziappLog::getInstance()->write('debug', "The batch processing is finished, marked as finished",
                                            "post_install.wiziapp_batch_processing_finish");
    ...
    public function display(){
        ...
        WiziappLog::getInstance()->write('info', "Going to process the following posts ids: " . print_r($postsIds, TRUE),
                                        "post_install.wiziapp_activate_display");
        WiziappLog::getInstance()->write('info', "Going to process the following posts names: " . print_r($postsNames, TRUE),
                                        "post_install.wiziapp_activate_display");
        ...
        WiziappLog::getInstance()->write('info', "Going to process the following pages ids: " . print_r($pagesIds, TRUE),
                                        "post_install.wiziapp_activate_display");
        WiziappLog::getInstance()->write('info', "Going to process the following pages names: " . print_r($pagesNames, TRUE),
                                        "post_install.wiziapp_activate_display");
        ?>
