...
class WiziappContentEvents{
    ...
    */
    public function generateLatest(){
        ...
        WiziappLog::getInstance()->write('info', "Parsing the latest content", "content");
        ...
        WiziappLog::getInstance()->write('info', "Processing all pages", 'content');
        ...
        WiziappLog::getInstance()->write('info', "Finished parsing initial content", 'content');
