    ...
    if ( $maint ){
            ...
            <div class="wiziapp_errors_container s_container" style="top:40%;">
                <div class="errors">
                    <div class="wiziapp_error">
                        Your website is running in maintenance mode, while in this mode the WiziApp wizard can't run.
                    </div>
                </div>
            </div>
        <?php
        ...
        if (!$tokenResponse['header']['status']) {
            ...
            #create_account_modal .error{
                background: url(<?php echo WiziappConfig::getInstance()->getCdnServer(); ?>/images/generator/validetion_error_Icon.png) no-repeat 0px 28px;
