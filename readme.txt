...
Our user-friendly wizard allows you to customize your app and make it your own; by giving it an app name, designing the splash screen, and customize your theme and your own Tab Bar menu. As you customize your app you will see your changes in real-time in our simulator.
Decide whether you would like to keep your app "Ads free", or monetize it by displaying ads using your own AdMob account, or sell your App on the Appstore.
...
- Customize the push notification message per each post or page.
...
- Support the device local language.
- Advanced interface that allows creating content exclusively for your App using your Wordpress system.
...
Yes, you can display ads using your AdMob account or sell your App on the Appstore.
