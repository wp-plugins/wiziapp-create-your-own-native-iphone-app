...
WiziApp is a plugin that turns your WordPress powered website into an HTML5 mobile App for your iPhone, Android and Windows Phone users. The HTML5 mobile WebApp enables your mobile users to access your website from their mobile devices browser and enjoy an advanced  user experience.
You can also publish your mobile App as a native mobile App to the Apple App Store and Google Play Android market.

= Just "plugin" and play! =

Our user-friendly wizard allows you to customize your mobile App and make it your own; by designing the App splash screen & icon, customizing your theme and selecting your own Tab Bar menu items. As you customize your mobile App you will see your changes in real-time in our simulator.
Integrate Seamlessly with your Wordpress System
The WiziApp plugin integrates seamlessly with WordPress, delivering all of your content, including; Posts, Pages, Comments, Categories, Tags, Links, Images, Videos and Audio files, to your HTML5 mobile Web App, iPhone App & Android App quickly, easily and in real time.

= Publish your mobile App to the Apple AppStore and Google Play Android Market =
...
- Enable your mobile users to access your website from their mobile devices browser and enjoy an advanced mobile App user experience.
- Publish your mobile App as a native iPhone App to the Apple App Store.
- Publish your mobile App as a native Android App to the Google Play Android market.
- Your users can easily read and post new comments directly from your mobile App.
- Display your images and galleries in a mobile native App style.
- All the videos you have posted will be collected to a Video libraries.
- Playing video and audio using advanced mobile players.
...
Installing the WiziApp WordPress mobile App Plugin from your WordPress admin panel:

1. Go to the "Plugins" / "Add new" on the left main menu.
2. Type WiziApp within the search box and click "Search Plugins".
3. Choose the "WiziApp - Create Mobile App (HTML5, Android, iPhone)" Plugin and click "Install Now".
4. Click "Activate Plugin".
5. Click the WiziApp button on the left main menu to start creating your own mobile App.

Download and Install the WiziApp mobile App Plugin from wordpress plugin directory or from the WiziApp website:
...
4. Choose the "WiziApp - Create Mobile App (HTML5, Android, iPhone)" plugin and click "Install Now".
...
= What is WiziApp? =
WiziApp is a plugin that turns your WordPress powered website into an HTML5 mobile App for your iPhone, Android and Windows Phone users. The HTML5 mobile WebApp enables your mobile users to access your website from their mobile devices browser and enjoy an advanced  native mobile App user experience.
You can also publish your mobile App as a native App to the Apple App Store and Google Play Android market.
...
The WiziApp plugin is compatible with WordPress versions 2.9 and up.
...
The push notifications service is available for native mobile Apps that were published to the mobile stores.
...
The App Store & Google Play Android Market are the world's largest application platforms, which is a great way for you to expose your content to a new audience.
The native mobile App also enables you to notify your readers about new content directly to their mobile devices  in real time using push notification service that runs and maintained by WiziApp.
...
Yes, you can sell your native mobile App.
...
Yes, your App name and tab Bar menu, can all be edited and inserted in your own language.
The native mobile Apps metadata on the App Store & Google Play Android Market which includes the App name, description and  keywords, can also be edited to your own language.
...
Yes, you can customize and create a mobile App for each of your websites.
...
Please see a guide at: Admob ads for your iPhone App.
Please note, that monetizing your mobile App with ads is currently available only for the iPhone native App.

= How do I create an Apple developer account? =
Please see a guide at:
[Get an Apple developer account](http://www.wiziapp.com/blog/guides-tutorials/get-apple-developer-account/)
