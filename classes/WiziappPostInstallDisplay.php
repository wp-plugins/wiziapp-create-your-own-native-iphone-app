...
class WiziappPostInstallDisplay{
	...
	*/
	...
	public function batchProcessingFinish(){
		WiziappLog::getInstance()->write('INFO', "The batch processing is finished, marking as finished",
		...
		WiziappLog::getInstance()->write('INFO', "The batch processing is finished, marked as finished",
											"post_install.wiziapp_batch_processing_finish");
