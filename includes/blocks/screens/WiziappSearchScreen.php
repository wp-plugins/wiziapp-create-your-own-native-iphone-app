...
class WiziappSearchScreen extends WiziappPostsScreen{
    ...
    */
    public function runByQuery(){
        ...
        WiziappLog::getInstance()->write('info', "Searching for posts for {$category}, and with the chars: {$keyword}", "search.wiziapp_do_search");
    ...
    */
    public function runByKeywords(){
        ...
        if (isset($_GET['callback'])){
            ...
            */
            ...
            WiziappLog::getInstance()->write('debug', "The callback GET param is not set",
    ...
    private function getTerms($chars, $return_id = FALSE){
        ...
        WiziappLog::getInstance()->write('info', "The sql was: {$sql}", "search.wiziapp_get_terms");
        WiziappLog::getInstance()->write('info', "The terms are: " . print_r($terms, TRUE), "search.wiziapp_get_terms");
