...
class WiziappArchivesScreen extends WiziappBaseScreen{
    ...
    public function run(){
        ...
        WiziappLog::getInstance()->write('info', "Prepared the archive query: {$query}", "screens.wiziapp_buildArchiveYearsPage");
        $key = md5($query);
    ...
    public function runByYear($year){
        ...
        WiziappLog::getInstance()->write('info', "Prepared the archive query: {$query}",
