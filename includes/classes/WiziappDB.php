...
class WiziappDB implements WiziappIInstallable{
    ...
    */
    function find_content_media($id, $type, $media_type) {
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.find_content_media');
    ...
    function get_media_data($media_type = 'image', $key, $value){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_media_data');
        $result = $wpdb->get_results($sql, ARRAY_A);
    ...
    function get_images_for_albums(){
        ...
        $sql = $wpdb->prepare("SELECT * FROM {$wpdb->prefix}{$this->media_table} AS c WHERE c.attachment_type = %d AND (attachment_info LIKE %s OR attachment_info LIKE %s OR attachment_info LIKE %s OR attachment_info LIKE %s OR attachment_info LIKE %s OR attachment_info LIKE %s)", $this->media_types["image"], '%data-wiziapp-cincopa-id%', '%data-wiziapp-nextgen-album-id%', '%data-wiziapp-nextgen-gallery-id%', '%data-wiziapp-pageflipbook-id%', '%wordpress-gallery-id%', '%external-gallery-id%', '%data-wiziapp-id%');
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_images_for_albums');
    ...
    function get_media_metadata_equal($media_type = 'image', $key, $value){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_media_metadata_equal');
        $result = $wpdb->get_results($sql, ARRAY_A);
    ...
    function get_media_metadata_not_equal($media_type='image', $keys=array()){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_media_metadata_not_equal');
        $result = $wpdb->get_results($sql, ARRAY_A);
...
//        $sql .= '(%d, %d, %s, %s, %d, %s, %s),';
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$query}", 'db.add_content_medias');
    ...
    */
    function add_content_media($content_id, $type, $media_type, $media_info, $html){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.add_content_media');
    ...
    */
    function delete_content_media($content_id, $content_type='post'){
          ...
          WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.delete_content_media');
    ...
    */
    function get_all_videos($offset = 0, $limit = 0){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_all_videos');
        $result = $wpdb->get_results($sql, ARRAY_A);
    ...
    */
    function get_all_images(){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_all_images');
        $result = $wpdb->get_results($sql, ARRAY_A);
    ...
    */
    function get_videos_count(){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_videos_count');
    ...
    */
    function get_albums_count(){
        ...
        $sql = $wpdb->prepare("SELECT COUNT(id) 
                                ...
                                LIMIT 0, 15");
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_albums_count');
    ...
    */
    function get_images_post_albums_count($image_in_album){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_images_post_albums_count');
    ...
    */
    function get_audios_post_albums_count($audio_in_album){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_audios_post_albums_count');
    ...
    */
    function get_all_audios($offset = 0, $limit = 0){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_all_audios');
        $result = $wpdb->get_results($sql, ARRAY_A);
    ...
    */
    function get_videos_by_id($id){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_videos_by_id');
    ...
    */
    function get_content_special_elements($content_id){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_content_special_elements');
        $result = $wpdb->get_results($sql, ARRAY_A);
    ...
    */
    function get_content_images($content_id){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_content_images');
        $result = $wpdb->get_results($sql, ARRAY_A);
    ...
    function get_content_by_media_id($id){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_content_by_media_id');
    ...
    function get_links_count(){
        ...
        WiziappLog::getInstance()->write('info', "About to run the sql: {$sql}", 'db.get_links_count');
        $result = $wpdb->get_var($sql);
        return $result;
    }
    ...
    public function isInstalled(){
        ...
        return ($wpdb->get_var("show tables like '{$wpdb->prefix}{$this->media_table}'") == $wpdb->prefix.$this->media_table);
    }
