...
class WiziappUserServices{
    ...
    public function updateUserData($udid, $params, $updateAdmin = true){
        ...
        foreach ($params as $key => $value){
            $userInfo[$key]=$value; //this part is somewhat superfluos
            $format[]='%s';         //this too is superfluos; it's the default behaviour
        }
        $where['udid']=$udid;
        ...
        return $result; // could be 0 or false or actual result
    }
