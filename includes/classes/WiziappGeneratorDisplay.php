...
class WiziappGeneratorDisplay{
	...
	public static function display(){
		...
		<div id="wiziapp_plugins_install">
			<div class="wiziapp_plugins_header">
				<div class="wiziapp_logo">
					<img src="<?php echo WiziappConfig::getInstance()->getCdnServer(); ?>/images/generator/main_logo.png" alt="Extend your reach" />
				</div>

				<ul id="wiziapp_main_tabs">
					<li class="wiziapp">
						<a href="#" data-request-params="my_apps_tab_li">My Apps</a>
					</li>
					<li class="wiziapp">
						<a href="#" data-request-params="my_plan_tab_li">My Plan</a>
					</li>
					<li class="wiziapp">
			...
			<p>
				Add functionality to your WiziApp powered mobile Apps with the following WP plugins:
			</p>
