...
<div data-role="page" id="search" class="got_empty_state" data-class="search_screen">
	<div data-role="header" data-id="header" data-position="fixed">
		<h1>Search</h1>
	</div><!-- /header -->

	<div data-role="content" data-footer-id="tabbar">
		<form action="<?php echo esc_url( WiziappContentHandler::getInstance()->get_blog_property('url').'/?wiziapp/search&category=all&search=1'.WiziappLinks::getAppend() ); ?>" method="get">
			<label for="webapp_search_field">
				<input id="webapp_search_field" type="text" name="keyword" value="" />
			</label>
			<input name="submit" type="submit" value="Search" data-theme="a" />
		</form>
	</div><!-- /content -->

	<?php echo $tabBar->getBar('search'); ?>
</div><!-- /page -->
...
<!--
<div class="hidden"><a href="#" id="webview_links_handler"></a></div>
