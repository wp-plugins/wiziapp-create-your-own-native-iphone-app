...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_bloginfo('template_url').'/resources/main.css'; ?>" type="text/css" />
	...
	<script type="text/javascript" src="<?php echo get_bloginfo('template_url').'/resources/handshake.js'; ?>"></script>
	<script type="text/javascript" src="<?php echo get_bloginfo('template_url').'/resources/config.js'; ?>"></script>
	<script type="text/javascript">
		window.WiziappPlatformVersion = '<?php echo WIZIAPP_P_VERSION; ?>';
		window.WiziappAccessPoint = '<?php echo site_url(); ?>';
